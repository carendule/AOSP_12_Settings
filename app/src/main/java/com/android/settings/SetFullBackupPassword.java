            ...
            if (v == mSet) {
                ...
                if (!newPw.equals(confirmPw)) {
                    ...
                    Toast.makeText(SetFullBackupPassword.this,
                            com.android.settingslib.R.string.local_backup_password_toast_confirmation_mismatch,
                ...
                if (setBackupPassword(curPw, newPw)) {
                    ...
                    Toast.makeText(SetFullBackupPassword.this,
                            com.android.settingslib.R.string.local_backup_password_toast_validation_failure,
                            Toast.LENGTH_LONG).show();
                }
            } else if (v == mCancel) {
                finish();
