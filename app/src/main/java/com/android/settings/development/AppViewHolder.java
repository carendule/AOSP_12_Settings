...
public class AppViewHolder {
    ...
    static public AppViewHolder createOrRecycle(LayoutInflater inflater, View convertView) {
        if (convertView == null) {
            convertView = inflater.inflate(com.android.settingslib.widget.R.layout.preference_app, null);
            ...
            holder.disabled = convertView.findViewById(com.android.settingslib.widget.R.id.appendix);
