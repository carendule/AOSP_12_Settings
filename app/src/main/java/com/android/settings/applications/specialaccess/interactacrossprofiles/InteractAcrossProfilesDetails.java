...
public class InteractAcrossProfilesDetails extends AppInfoBase
    ...
    private void addAppTitleAndIcons(UserHandle personalProfile, UserHandle workProfile) {
        ...
        final ImageView personalIconView = mHeader.findViewById(com.android.settingslib.widget.R.id.entity_header_icon_personal);
        ...
        final ImageView workIconView = mHeader.findViewById(com.android.settingslib.widget.R.id.entity_header_icon_work);
    ...
    private void enableSwitchPref() {
        ...
        final ImageView horizontalArrowIcon = mHeader.findViewById(com.android.settingslib.widget.R.id.entity_header_swap_horiz);
        if (horizontalArrowIcon != null) {
            horizontalArrowIcon.setImageDrawable(
                    mContext.getDrawable(com.android.settingslib.widget.R.drawable.ic_swap_horiz_blue));
        }
    }
    ...
    private void disableSwitchPref() {
        ...
        if (horizontalArrowIcon != null) {
            horizontalArrowIcon.setImageDrawable(
                    mContext.getDrawable(com.android.settingslib.widget.R.drawable.ic_swap_horiz_grey));
        }
    }
